  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface px-4">
      <div className="max-w-md text-center">
        <div className="mx-auto mb-6 grid h-16 w-16 place-items-center rounded-2xl bg-gradient-brand shadow-glow">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-lg bg-gradient-brand px-5 py-2.5 text-sm font-medium text-white shadow-card transition-all hover:opacity-90"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ConsiTrack — Turn Daily Discipline Into Real Rewards" },
      {
        ...
        content:
          "AI-verified habits, streak shields, badges, and a career-focused reward economy.",
      },
